...
app.post('/api/reportes', (req, res) => {
  const { service, date, price, received, change_amount } = req.body; // Ensure "change" is renamed to "change_amount"
  ...
  pool.query(query, [service, date, price, received, change_amount], (err, result) => { // Use pool.query instead of db.query
    if (err) {
